...
We'll be using RStudio to help us use R. *RStudio is to R and Microsoft Word is to English* -- that is, we can write R code in RStudio, just as you may have written a paper in Microsoft Word prior to this course. Follow the steps below to install RStudio.
